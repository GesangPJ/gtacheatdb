    ...
    <div className="w-full px-4 sm:px-8 lg:px-16 min-h-[75vh] flex flex-col items-center mt-14">
      <div className="text-white">
        ...
        <div class="disclaimer text-white text-sm mt-9 mb-5">
            <p>
                This GTA V Cheats divided into some verison / types, phonecode that work for all platforms,
                and then cheat for each platforms such as PC, XBOX&trade; and PlayStation&trade; 

            </p>
            <p>
            Below is the instruction on how to use the phonecode cheat in GTA V :
            <ol class="mt-4">
            ...
            <table className="table-auto w-full max-w-4xl mx-auto text-left text-lg font-light text-surface mt-6 mb-14">
              <thead className="border-b border-neutral-200 font-medium border-white/10">
                <tr className="border-t border-white bg-blue-900">
                  ...
                  <th className="w-48 sm:w-64 lg:w-80 border-r border-white text-center text-xl">PhoneCode</th>
                  <th className="w-72 sm:w-96 lg:w-[24rem] border-r border-white text-center text-xl">Phrase</th>
              ...
              <tbody>
                {cheats.map((cheat, index) => (
                  <tr key={cheat._id} className="border-b border-neutral-200">
                    ...
                    <td className="w-48 sm:w-64 lg:w-80 border-r border-white px-2 sm:px-4 lg:px-6">{cheat.phonecode}</td>
                    <td className="w-72 sm:w-96 lg:w-[24rem] border-r border-white px-2 sm:px-4 lg:px-6">{cheat.phrase}</td>
